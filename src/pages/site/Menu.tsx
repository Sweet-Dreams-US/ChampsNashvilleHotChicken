...
const GRID_FOR: Record<CategoryKey, string> = {
  entrees: 'sm:grid-cols-2 lg:grid-cols-3',
  family: 'sm:grid-cols-2',
  kids: 'sm:grid-cols-2',
  sides: 'sm:grid-cols-2 lg:grid-cols-4',
  drinks: 'sm:grid-cols-2 lg:grid-cols-4',
  desserts: 'sm:grid-cols-2',
}
  ...
  return (
    <div>
      ...
      <header className="relative overflow-hidden border-b border-bone/10 bg-coal px-4 pb-12 pt-32 sm:px-6">
        <HeaderBackdrop image={asset('assets/menu/over-fries-mac.jpg')} />
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <p className="mt-3 max-w-lg font-sans text-smoke">
            Tap your heat, tap add — your bag fills as you browse. Everything is
