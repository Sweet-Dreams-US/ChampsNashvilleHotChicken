        ...
        >
          ...
          >
            <motion.div variants={fadeUp}>
              <Eyebrow>Fort Wayne, IN · Nashville Hot · Made Fresh Daily</Eyebrow>
            </motion.div>
            ...
            >
              <span className="block text-[clamp(2rem,6vw,4.5rem)] tracking-billboard">
                NASHVILLE HOT
              </span>
              <span className="relative mt-1 inline-block">
                <span className="block text-[clamp(2.6rem,8.5vw,6.25rem)] text-ember neon-ember">
                  DONE RIGHT
                </span>
                <SauceDrips />
              </span>
            ...
            >
              Premium Nashville hot chicken — hand-breaded and cooked to order,
              dialed from a friendly Mild to the no-mercy Reaper&apos;s Rush.
            </motion.p>
...
const STORY_POINTS = [
  { n: '01', title: 'Quality First', copy: 'Premium ingredients, breaded by hand — every single order.' },
  { n: '02', title: 'Cooked to Order', copy: 'Nothing sits. Your bird hits the oil when your ticket prints.' },
  { n: '03', title: 'Bold Flavor', copy: 'The heat and flavor Nashville is known for, dialed to your level.' },
]
      ...
      <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
        <Reveal>
          ...
          <h2 className="mt-3 font-display text-5xl leading-[0.9] text-bone sm:text-6xl">
            THIS ISN&apos;T JUST <span className="text-ember">CHICKEN</span>
          </h2>
          <p className="mt-5 font-sans leading-relaxed text-smoke">
            Champs started with one idea: serve high-quality Nashville hot
            chicken that brings people together. No shortcuts, no heat-lamp
            leftovers — just hand-breaded, cooked-to-order chicken and a heat
            ladder that runs from a friendly Mild to the no-mercy Reaper&apos;s
            Rush. This isn&apos;t just chicken — this is Champs.
          </p>
          <Link
            to="/about"
