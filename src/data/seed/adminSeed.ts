...
const STAFF: StaffMember[] = [
  { id: 's1', name: 'Marcus Webb', role: 'Owner', phone: '(260) 555-0110', email: 'marcus@champs.com', payRate: 0, status: 'active', startedAt: '2024-01-15' },
  { id: 's2', name: 'Tasha Holloway', role: 'General Manager', phone: '(260) 555-0112', email: 'tasha@champs.com', payRate: 24, status: 'active', startedAt: '2024-02-01' },
  { id: 's3', name: 'Andre Cole', role: 'Lead Cook', phone: '(260) 555-0118', email: 'andre@champs.com', payRate: 21, status: 'active', startedAt: '2024-02-10' },
  { id: 's4', name: 'Priya Nair', role: 'Cook', phone: '(260) 555-0124', email: 'priya@champs.com', payRate: 18, status: 'active', startedAt: '2024-05-06' },
  { id: 's5', name: 'Devon Pierce', role: 'Cook', phone: '(260) 555-0131', email: 'devon@champs.com', payRate: 17.5, status: 'active', startedAt: '2024-07-22' },
  { id: 's6', name: 'Jordan Reyes', role: 'Cashier', phone: '(260) 555-0140', email: 'jordan@champs.com', payRate: 15, status: 'active', startedAt: '2024-09-03' },
  { id: 's7', name: 'Sam Whitfield', role: 'Prep / Cashier', phone: '(260) 555-0147', email: 'sam@champs.com', payRate: 15, status: 'off', startedAt: '2025-01-14' },
  { id: 's8', name: 'Lena Brooks', role: 'Delivery Driver', phone: '(260) 555-0153', email: 'lena@champs.com', payRate: 14 + 0, status: 'active', startedAt: '2025-02-18' },
]
...
const EVENTS: AdminEvent[] = [
  ...
  { id: 'e4', title: 'Fort Wayne Food Truck Fest', type: 'community', date: dateFromNow(16), time: '11:00 AM', location: 'Headwaters Park', status: 'upcoming', notes: 'Booth + tender boxes. Need pop-up tent + 2 staff.' },
...
const SOCIALS: SocialPlatform[] = [
  { key: 'instagram', name: 'Instagram', handle: '@champs.chicken', followers: 4287, growthPct: 6.4, engagementPct: 5.2, reach30d: 38400 },
  { key: 'facebook', name: 'Facebook', handle: 'Champs', followers: 1842, growthPct: 2.1, engagementPct: 3.1, reach30d: 14200 },
  { key: 'tiktok', name: 'TikTok', handle: '@champs.chicken', followers: 9613, growthPct: 18.7, engagementPct: 9.8, reach30d: 214000 },
]
