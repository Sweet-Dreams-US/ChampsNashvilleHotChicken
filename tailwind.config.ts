...
/**
 * Champs Chicken design system — "Nashville Hot"
 * A fiery-red, ember-orange, charcoal-dark hot-chicken aesthetic:
 * flame, smoke, sauce, and that brushed-signage glow.
 */
export default {
  ...
  theme: {
    extend: {
      colors: {
        ...
        char: '#0E0A08', // app background
        coal: '#17110D', // raised background / sections
        ash: '#221913', // card surface
        soot: '#2E221B', // hairline borders / lifted surface

        // Flame ramp — the Champs brand voice (fiery red + ember)
        ember: {
          DEFAULT: '#E5202A', // primary Champs red
          bright: '#FF3B36',
          deep: '#8E1118',
        },
        molten: '#FF7A1A', // ember orange
        flare: '#F4B731', // warm gold accent (prices, "Nashville Hot")

        // Type
        bone: '#F7EFE6', // primary text (warm cream)
        smoke: '#A99C8E', // muted text (warm gray)

        // Sparingly-used hot accent (signage glow, focus, "live")
        neon: '#FF3B30',

        // Heat-level ramp — recurring interactive motif (Plain → Reaper's Rush)
        heat: {
          none: '#74B49A',
          mild: '#F4B731',
          hot: '#FF7A1A',
      ...
      boxShadow: {
        ...
        'glow-neon': '0 0 26px -4px rgba(255,59,48,0.7)',
